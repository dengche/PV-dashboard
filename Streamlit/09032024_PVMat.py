...
from pysd.py_backend.functions import if_then_else, sum
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_material_price": 1,
        "_delayfixed_material_price_1": 1,
        "_delayfixed_material_price_2": 1,
    },
    other_deps={
        "_delayfixed_material_price": {
            "initial": {"initial_material_price": 1, "supply_gap_delay": 1},
            "step": {"a_price": 1, "annual_material_surplus": 1, "b_price": 1},
        },
        "_delayfixed_material_price_1": {
            "initial": {"initial_material_price": 1, "supply_gap_delay": 1},
            "step": {
                "a_price": 1,
                "annual_material_surplus": 2,
                "b_price": 1,
                "c_price": 1,
            },
        },
        "_delayfixed_material_price_2": {
            "initial": {"initial_material_price": 1, "supply_gap_delay": 1},
            "step": {
                "a_price": 1,
                "annual_material_surplus": 3,
                "b_price": 1,
                "c_price": 1,
                "d_price": 1,
            },
...
def material_price():
    return if_then_else(
        ...
        lambda: _delayfixed_material_price(),
        lambda: if_then_else(
            supplygap_price_eq_degree() == 2,
            lambda: _delayfixed_material_price_1(),
            lambda: _delayfixed_material_price_2(),
        ),
    )


_delayfixed_material_price = DelayFixed(
    lambda: a_price() * annual_material_surplus() + b_price(),
    lambda: supply_gap_delay(),
    lambda: initial_material_price(),
    time_step,
    "_delayfixed_material_price",
)

_delayfixed_material_price_1 = DelayFixed(
    lambda: a_price() * annual_material_surplus() ** 2
...
_delayfixed_material_price_2 = DelayFixed(
    lambda: a_price() * annual_material_surplus() ** 3
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_annual_dismantled_pv": 1,
        "dismantled_pv_per_production_phase": 1,
    },
    other_deps={
        "_delayfixed_annual_dismantled_pv": {
            "initial": {"average_pv_lifetime": 1},
            "step": {"dismantled_pv_per_production_phase": 1},
        }
    },
)
def annual_dismantled_pv():
    return if_then_else(
        new_pv_recycling_estimation_method() == 1,
        lambda: _delayfixed_annual_dismantled_pv(),
        lambda: sum(dismantled_pv_per_production_phase(), dim=[]),
    )


_delayfixed_annual_dismantled_pv = DelayFixed(
    lambda: float(dismantled_pv_per_production_phase().loc["Y2023"]),
    lambda: average_pv_lifetime() - 1,
    lambda: 0,
    time_step,
    "_delayfixed_annual_dismantled_pv",
)
...
@component.add(
    ...
    comp_subtype="Normal",
    depends_on={
        "actual_annual_material_demand": 2,
        "annual_material_demand": 2,
        "material_production_annual": 2,
    },
)
def annual_material_surplus():
    return if_then_else(
        actual_annual_material_demand() < annual_material_demand(),
        lambda: material_production_annual() - actual_annual_material_demand(),
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_delayed_yield_effect": 1},
    other_deps={
        "_delayfixed_delayed_yield_effect": {
            "initial": {"price_yield_delay": 1},
            "step": {"effect_on_material_byproduction_yield": 1},
        }
    },
)
def delayed_yield_effect():
    return _delayfixed_delayed_yield_effect()


_delayfixed_delayed_yield_effect = DelayFixed(
    lambda: effect_on_material_byproduction_yield(),
    lambda: price_yield_delay(),
    lambda: 1,
    time_step,
    "_delayfixed_delayed_yield_effect",
)
...
@component.add(
    ...
    comp_subtype="DelayFixed",
    depends_on={
        "_delayfixed_recycling_annual_pv": 1,
        "_delayfixed_recycling_annual_pv_1": 1,
        "_delayfixed_recycling_annual_pv_2": 1,
        "_delayfixed_recycling_annual_pv_3": 1,
        "_delayfixed_recycling_annual_pv_4": 1,
        "_delayfixed_recycling_annual_pv_5": 1,
        "_delayfixed_recycling_annual_pv_6": 1,
        "_delayfixed_recycling_annual_pv_7": 1,
        "_delayfixed_recycling_annual_pv_8": 1,
        "_delayfixed_recycling_annual_pv_9": 1,
        "_delayfixed_recycling_annual_pv_10": 1,
        "_delayfixed_recycling_annual_pv_11": 1,
        "_delayfixed_recycling_annual_pv_12": 1,
        "_delayfixed_recycling_annual_pv_13": 1,
        "_delayfixed_recycling_annual_pv_14": 1,
        "_delayfixed_recycling_annual_pv_15": 1,
        "_delayfixed_recycling_annual_pv_16": 1,
        "_delayfixed_recycling_annual_pv_17": 1,
        "_delayfixed_recycling_annual_pv_18": 1,
        "_delayfixed_recycling_annual_pv_19": 1,
        "_delayfixed_recycling_annual_pv_20": 1,
        "_delayfixed_recycling_annual_pv_21": 1,
        "_delayfixed_recycling_annual_pv_22": 1,
        "_delayfixed_recycling_annual_pv_23": 1,
        "_delayfixed_recycling_annual_pv_24": 1,
        "_delayfixed_recycling_annual_pv_25": 1,
        "_delayfixed_recycling_annual_pv_26": 1,
        "_delayfixed_recycling_annual_pv_27": 1,
    },
    other_deps={
        ...
        "_delayfixed_recycling_annual_pv_1": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_2": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_3": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_4": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_5": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_6": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_7": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_8": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_9": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_10": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_11": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_12": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_13": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_14": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_15": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_16": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_17": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_18": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_19": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_20": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_21": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_22": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_23": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_24": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_25": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_26": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
        "_delayfixed_recycling_annual_pv_27": {
            "initial": {},
            "step": {"actual_annual_material_demand": 1},
        },
    },
...
def recycling_annual_pv():
    value = xr.DataArray(np.nan, {"PVDev": _subscript_dict["PVDev"]}, ["PVDev"])
    value.loc[["Y2023"]] = _delayfixed_recycling_annual_pv().values
    value.loc[["Y2024"]] = _delayfixed_recycling_annual_pv_1().values
    value.loc[["Y2025"]] = _delayfixed_recycling_annual_pv_2().values
    value.loc[["Y2026"]] = _delayfixed_recycling_annual_pv_3().values
    value.loc[["Y2027"]] = _delayfixed_recycling_annual_pv_4().values
    value.loc[["Y2028"]] = _delayfixed_recycling_annual_pv_5().values
    value.loc[["Y2029"]] = _delayfixed_recycling_annual_pv_6().values
    value.loc[["Y2030"]] = _delayfixed_recycling_annual_pv_7().values
    value.loc[["Y2031"]] = _delayfixed_recycling_annual_pv_8().values
    value.loc[["Y2032"]] = _delayfixed_recycling_annual_pv_9().values
    value.loc[["Y2033"]] = _delayfixed_recycling_annual_pv_10().values
    value.loc[["Y2034"]] = _delayfixed_recycling_annual_pv_11().values
    value.loc[["Y2035"]] = _delayfixed_recycling_annual_pv_12().values
    value.loc[["Y2036"]] = _delayfixed_recycling_annual_pv_13().values
    value.loc[["Y2037"]] = _delayfixed_recycling_annual_pv_14().values
    value.loc[["Y2038"]] = _delayfixed_recycling_annual_pv_15().values
    value.loc[["Y2039"]] = _delayfixed_recycling_annual_pv_16().values
    value.loc[["Y2040"]] = _delayfixed_recycling_annual_pv_17().values
    value.loc[["Y2041"]] = _delayfixed_recycling_annual_pv_18().values
    value.loc[["Y2042"]] = _delayfixed_recycling_annual_pv_19().values
    value.loc[["Y2043"]] = _delayfixed_recycling_annual_pv_20().values
    value.loc[["Y2044"]] = _delayfixed_recycling_annual_pv_21().values
    value.loc[["Y2045"]] = _delayfixed_recycling_annual_pv_22().values
    value.loc[["Y2046"]] = _delayfixed_recycling_annual_pv_23().values
    value.loc[["Y2047"]] = _delayfixed_recycling_annual_pv_24().values
    value.loc[["Y2048"]] = _delayfixed_recycling_annual_pv_25().values
    value.loc[["Y2049"]] = _delayfixed_recycling_annual_pv_26().values
    value.loc[["Y2050"]] = _delayfixed_recycling_annual_pv_27().values
    return value


_delayfixed_recycling_annual_pv = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2023"]}, ["PVDev"]
    ),
    lambda: 0,
...
_delayfixed_recycling_annual_pv_1 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2024"]}, ["PVDev"]
    ),
    lambda: 1,
    lambda: xr.DataArray(0, {"PVDev": ["Y2024"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_1",
)

_delayfixed_recycling_annual_pv_2 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2025"]}, ["PVDev"]
    ),
    lambda: 2,
    lambda: xr.DataArray(0, {"PVDev": ["Y2025"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_2",
)

_delayfixed_recycling_annual_pv_3 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2026"]}, ["PVDev"]
    ),
    lambda: 3,
    lambda: xr.DataArray(0, {"PVDev": ["Y2026"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_3",
)

_delayfixed_recycling_annual_pv_4 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2027"]}, ["PVDev"]
    ),
    lambda: 4,
    lambda: xr.DataArray(0, {"PVDev": ["Y2027"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_4",
)

_delayfixed_recycling_annual_pv_5 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2028"]}, ["PVDev"]
    ),
    lambda: 5,
    lambda: xr.DataArray(0, {"PVDev": ["Y2028"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_5",
)

_delayfixed_recycling_annual_pv_6 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2029"]}, ["PVDev"]
    ),
    lambda: 6,
    lambda: xr.DataArray(0, {"PVDev": ["Y2029"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_6",
)

_delayfixed_recycling_annual_pv_7 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2030"]}, ["PVDev"]
    ),
    lambda: 7,
    lambda: xr.DataArray(0, {"PVDev": ["Y2030"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_7",
)

_delayfixed_recycling_annual_pv_8 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2031"]}, ["PVDev"]
    ),
    lambda: 8,
    lambda: xr.DataArray(0, {"PVDev": ["Y2031"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_8",
)

_delayfixed_recycling_annual_pv_9 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2032"]}, ["PVDev"]
    ),
    lambda: 9,
    lambda: xr.DataArray(0, {"PVDev": ["Y2032"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_9",
)

_delayfixed_recycling_annual_pv_10 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2033"]}, ["PVDev"]
    ),
    lambda: 10,
    lambda: xr.DataArray(0, {"PVDev": ["Y2033"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_10",
)

_delayfixed_recycling_annual_pv_11 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2034"]}, ["PVDev"]
    ),
    lambda: 11,
    lambda: xr.DataArray(0, {"PVDev": ["Y2034"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_11",
)

_delayfixed_recycling_annual_pv_12 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2035"]}, ["PVDev"]
    ),
    lambda: 12,
    lambda: xr.DataArray(0, {"PVDev": ["Y2035"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_12",
)

_delayfixed_recycling_annual_pv_13 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2036"]}, ["PVDev"]
    ),
    lambda: 13,
    lambda: xr.DataArray(0, {"PVDev": ["Y2036"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_13",
)

_delayfixed_recycling_annual_pv_14 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2037"]}, ["PVDev"]
    ),
    lambda: 14,
    lambda: xr.DataArray(0, {"PVDev": ["Y2037"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_14",
)

_delayfixed_recycling_annual_pv_15 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2038"]}, ["PVDev"]
    ),
    lambda: 15,
    lambda: xr.DataArray(0, {"PVDev": ["Y2038"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_15",
)

_delayfixed_recycling_annual_pv_16 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2039"]}, ["PVDev"]
    ),
    lambda: 16,
    lambda: xr.DataArray(0, {"PVDev": ["Y2039"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_16",
)

_delayfixed_recycling_annual_pv_17 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2040"]}, ["PVDev"]
    ),
    lambda: 17,
    lambda: xr.DataArray(0, {"PVDev": ["Y2040"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_17",
)

_delayfixed_recycling_annual_pv_18 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2041"]}, ["PVDev"]
    ),
    lambda: 18,
    lambda: xr.DataArray(0, {"PVDev": ["Y2041"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_18",
)

_delayfixed_recycling_annual_pv_19 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2042"]}, ["PVDev"]
    ),
    lambda: 19,
    lambda: xr.DataArray(0, {"PVDev": ["Y2042"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_19",
)

_delayfixed_recycling_annual_pv_20 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2043"]}, ["PVDev"]
    ),
    lambda: 20,
    lambda: xr.DataArray(0, {"PVDev": ["Y2043"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_20",
)

_delayfixed_recycling_annual_pv_21 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2044"]}, ["PVDev"]
    ),
    lambda: 21,
    lambda: xr.DataArray(0, {"PVDev": ["Y2044"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_21",
)

_delayfixed_recycling_annual_pv_22 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2045"]}, ["PVDev"]
    ),
    lambda: 22,
    lambda: xr.DataArray(0, {"PVDev": ["Y2045"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_22",
)

_delayfixed_recycling_annual_pv_23 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2046"]}, ["PVDev"]
    ),
    lambda: 23,
    lambda: xr.DataArray(0, {"PVDev": ["Y2046"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_23",
)

_delayfixed_recycling_annual_pv_24 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2047"]}, ["PVDev"]
    ),
    lambda: 24,
    lambda: xr.DataArray(0, {"PVDev": ["Y2047"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_24",
)

_delayfixed_recycling_annual_pv_25 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2048"]}, ["PVDev"]
    ),
    lambda: 25,
    lambda: xr.DataArray(0, {"PVDev": ["Y2048"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_25",
)

_delayfixed_recycling_annual_pv_26 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2049"]}, ["PVDev"]
    ),
    lambda: 26,
    lambda: xr.DataArray(0, {"PVDev": ["Y2049"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_26",
)

_delayfixed_recycling_annual_pv_27 = DelayFixed(
    lambda: xr.DataArray(
        actual_annual_material_demand(), {"PVDev": ["Y2050"]}, ["PVDev"]
    ),
    lambda: 27,
    lambda: xr.DataArray(0, {"PVDev": ["Y2050"]}, ["PVDev"]),
    time_step,
    "_delayfixed_recycling_annual_pv_27",
)
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_direct_mining_supply_rough_estimate": 1},
    other_deps={
        "_delayfixed_direct_mining_supply_rough_estimate": {
            "initial": {"direct_mining_current_production_user_input": 1},
...
def direct_mining_supply_rough_estimate():
    ...
    2: Calculate based on current production and future growth
    """
    return _delayfixed_direct_mining_supply_rough_estimate()


_delayfixed_direct_mining_supply_rough_estimate = DelayFixed(
    lambda: annual_production(),
    lambda: 0,
    lambda: direct_mining_current_production_user_input(),
    time_step,
    "_delayfixed_direct_mining_supply_rough_estimate",
)
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_1": 1,
        "current_pv_material_byproduction_yield_1": 1,
    },
    other_deps={
        "_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_1": {
            "initial": {"current_pv_material_byproduction_yield_1": 1},
            "step": {
...
def hitchhiker_recovery_efficiency_from_host_metal_1():
    ...
    return if_then_else(
        hitchhiker_1_affected() == 1,
        lambda: _delayfixed_hitchhiker_recovery_efficiency_from_host_metal_1(),
        lambda: current_pv_material_byproduction_yield_1(),
    )


_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_1 = DelayFixed(
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_2": 1,
        "current_pv_material_byproduction_yield_2": 1,
    },
    other_deps={
        "_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_2": {
            "initial": {"current_pv_material_byproduction_yield_2": 1},
            "step": {
                "new_byproduction_yield_factor": 1,
                "current_pv_material_byproduction_yield_2": 1,
            },
...
def hitchhiker_recovery_efficiency_from_host_metal_2():
    ...
    return if_then_else(
        hitchhiker_2_affected() == 1,
        lambda: _delayfixed_hitchhiker_recovery_efficiency_from_host_metal_2(),
        lambda: current_pv_material_byproduction_yield_2(),
    )


_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_2 = DelayFixed(
    lambda: new_byproduction_yield_factor()
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_3": 1,
        "current_pv_material_byproduction_yield_3": 1,
    },
    other_deps={
        "_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_3": {
            "initial": {"current_pv_material_byproduction_yield_3": 1},
            "step": {
                "new_byproduction_yield_factor": 1,
                "current_pv_material_byproduction_yield_3": 1,
            },
...
def hitchhiker_recovery_efficiency_from_host_metal_3():
    ...
    return if_then_else(
        hitchhiker_3_affected() == 1,
        lambda: _delayfixed_hitchhiker_recovery_efficiency_from_host_metal_3(),
        lambda: current_pv_material_byproduction_yield_3(),
    )


_delayfixed_hitchhiker_recovery_efficiency_from_host_metal_3 = DelayFixed(
    lambda: new_byproduction_yield_factor()
...
@component.add(
    name="Supply Gap Delay", units="Years", comp_type="Constant", comp_subtype="Normal"
)
def supply_gap_delay():
    return 3
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_delayed_dmgr_effect": 1},
    other_deps={
        "_delayfixed_delayed_dmgr_effect": {
            "initial": {"price_dmgr_delay": 1},
            "step": {"effect_on_material_direct_mining_gr": 1},
        }
    },
)
def delayed_dmgr_effect():
    return _delayfixed_delayed_dmgr_effect()


_delayfixed_delayed_dmgr_effect = DelayFixed(
    lambda: effect_on_material_direct_mining_gr(),
    lambda: price_dmgr_delay(),
    lambda: 1,
    time_step,
    "_delayfixed_delayed_dmgr_effect",
)
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_annual_dismantled_existing_pv": 1,
        "dismantled_expv": 1,
    },
    other_deps={
        "_delayfixed_annual_dismantled_existing_pv": {
            "initial": {"average_existing_pv_lifetime": 1},
            "step": {"dismantled_expv": 1},
        }
    },
)
...
_delayfixed_annual_dismantled_existing_pv = DelayFixed(
    ...
    lambda: average_existing_pv_lifetime() - 1,
    lambda: 0,
    time_step,
    "_delayfixed_annual_dismantled_existing_pv",
)
...
@component.add(
    name="Recycled Material Flows Estimation Method",
    comp_type="Constant",
    comp_subtype="Normal",
)
def recycled_material_flows_estimation_method():
    """
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_delayed_yield_avg_effect": 1},
    other_deps={
        "_delayfixed_delayed_yield_avg_effect": {
            "initial": {"price_yield_avg_delay": 1},
            "step": {"effect_on_material_byproduction_yield_avg": 1},
        }
    },
)
def delayed_yield_avg_effect():
    return _delayfixed_delayed_yield_avg_effect()


_delayfixed_delayed_yield_avg_effect = DelayFixed(
    lambda: effect_on_material_byproduction_yield_avg(),
    lambda: price_yield_avg_delay(),
    lambda: 1,
    time_step,
    "_delayfixed_delayed_yield_avg_effect",
)
...
@component.add(
    ...
    comp_subtype="Normal",
    depends_on={
        "recycled_material_flows_estimation_method": 1,
...
@component.add(
    ...
    comp_subtype="Normal",
    depends_on={
        "actual_annual_material_demand": 3,
        "annual_material_demand": 3,
        "material_production_annual": 4,
    },
)
def material_in_the_market_negative():
    return np.maximum(
        if_then_else(
            actual_annual_material_demand() < annual_material_demand(),
            lambda: if_then_else(
                material_production_annual() - actual_annual_material_demand() > 0,
                lambda: 0,
                lambda: -material_production_annual() + actual_annual_material_demand(),
            ),
            lambda: if_then_else(
...
@component.add(
    ...
    depends_on={
        ...
        "_delayfixed_annual_capacity_incremental": 1,
        "_delayfixed_annual_capacity_incremental_1": 1,
    },
    other_deps={
        "_delayfixed_annual_capacity_incremental": {
            "initial": {"pv_deployment_initial_incremental": 1},
            "step": {
                "condition": 1,
                "counter_result": 27,
        ...
        "_delayfixed_annual_capacity_incremental_1": {
            "initial": {"pv_deployment_initial_incremental_user_input": 1},
            "step": {
                "condition": 1,
...
def annual_capacity_incremental():
    return np.maximum(
        if_then_else(
            pv_future_production_user_input() == 1,
            lambda: _delayfixed_annual_capacity_incremental(),
            lambda: _delayfixed_annual_capacity_incremental_1(),
        ),
        0,
    )


_delayfixed_annual_capacity_incremental = DelayFixed(
    lambda: if_then_else(
        condition() == 0,
        lambda: if_then_else(
            counter_result() == 1,
            lambda: float(planned_annual_incremental_capacity().loc["Y2023"]),
            lambda: if_then_else(
                counter_result() == 2,
                lambda: float(planned_annual_incremental_capacity().loc["Y2024"]),
                lambda: if_then_else(
                    counter_result() == 3,
                    lambda: float(planned_annual_incremental_capacity().loc["Y2025"]),
                    lambda: if_then_else(
                        counter_result() == 4,
                        lambda: float(
                            planned_annual_incremental_capacity().loc["Y2026"]
                        ),
                        lambda: if_then_else(
                            counter_result() == 5,
                            lambda: float(
                                planned_annual_incremental_capacity().loc["Y2027"]
                            ),
                            lambda: if_then_else(
                                counter_result() == 6,
                                lambda: float(
                                    planned_annual_incremental_capacity().loc["Y2028"]
                                ),
                                lambda: if_then_else(
                                    counter_result() == 7,
                                    lambda: float(
    ...
    lambda: 0,
    lambda: pv_deployment_initial_incremental(),
    time_step,
    "_delayfixed_annual_capacity_incremental",
)

_delayfixed_annual_capacity_incremental_1 = DelayFixed(
    lambda: if_then_else(
        condition() == 0,
        lambda: if_then_else(
            counter_result() == 1,
            lambda: float(
                planned_annual_incremental_capacity_user_input().loc["Y2023"]
            ),
            lambda: if_then_else(
                counter_result() == 2,
                lambda: float(
                    planned_annual_incremental_capacity_user_input().loc["Y2024"]
                ),
                lambda: if_then_else(
                    counter_result() == 3,
                    lambda: float(
                        planned_annual_incremental_capacity_user_input().loc["Y2025"]
                    ),
                    lambda: if_then_else(
                        counter_result() == 4,
                        lambda: float(
    ...
    lambda: 0,
    lambda: pv_deployment_initial_incremental_user_input(),
    time_step,
    "_delayfixed_annual_capacity_incremental_1",
)
...
@component.add(
    ...
    depends_on={
        ...
        "recycling_annual_pv": 2,
        "weibull_pdf_early_loss": 1,
        "weibull_pdf_regular_loss": 1,
        "_delayfixed_dismantled_pv_per_production_phase": 1,
    },
    other_deps={
        "_delayfixed_dismantled_pv_per_production_phase": {
            "initial": {},
            "step": {"recycling_annual_pv": 1},
        }
    },
)
def dismantled_pv_per_production_phase():
    return np.maximum(
        if_then_else(
            new_pv_recycling_estimation_method() == 2,
            lambda: xr.DataArray(
                recycling_annual_pv() * weibull_pdf_early_loss(),
                {"StudyPeriod": _subscript_dict["StudyPeriod"]},
                ["StudyPeriod"],
            ),
            lambda: if_then_else(
                ...
                lambda: xr.DataArray(
                    recycling_annual_pv() * weibull_pdf_regular_loss(),
                    {"StudyPeriod": _subscript_dict["StudyPeriod"]},
                    ["StudyPeriod"],
                ),
                lambda: _delayfixed_dismantled_pv_per_production_phase(),
            ),
        ),
        0,
    )
...
_delayfixed_dismantled_pv_per_production_phase = DelayFixed(
    lambda: xr.DataArray(
        recycling_annual_pv(),
        {"StudyPeriod": _subscript_dict["StudyPeriod"]},
        ["StudyPeriod"],
    ...
    lambda: 25,
    lambda: xr.DataArray(
        0, {"StudyPeriod": _subscript_dict["StudyPeriod"]}, ["StudyPeriod"]
    ),
    time_step,
    "_delayfixed_dismantled_pv_per_production_phase",
)
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_yield_dummy_out": 1},
    other_deps={
        "_delayfixed_yield_dummy_out": {"initial": {}, "step": {"yield_dummy_in": 1}}
    },
)
def yield_dummy_out():
    return np.maximum(_delayfixed_yield_dummy_out(), 0)


_delayfixed_yield_dummy_out = DelayFixed(
    lambda: yield_dummy_in(),
    lambda: 1,
    lambda: 1,
    time_step,
    "_delayfixed_yield_dummy_out",
)
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_dmgr_dummy_out": 1},
    other_deps={
        "_delayfixed_dmgr_dummy_out": {"initial": {}, "step": {"dmgr_dummy_in": 1}}
    },
)
def dmgr_dummy_out():
    return np.maximum(_delayfixed_dmgr_dummy_out(), 0)


_delayfixed_dmgr_dummy_out = DelayFixed(
    lambda: dmgr_dummy_in(),
    lambda: 1,
    lambda: 1,
    time_step,
    "_delayfixed_dmgr_dummy_out",
)
...
@component.add(
    ...
    depends_on={
        ...
        "recycling_annual_expv": 2,
        "weibull_pdf_early_loss_expv": 1,
        "weibull_pdf_regular_loss_expv": 1,
        "_delayfixed_dismantled_expv": 1,
    },
    other_deps={
        "_delayfixed_dismantled_expv": {
            "initial": {},
            "step": {"recycling_annual_expv": 1},
        }
    },
)
def dismantled_expv():
    return np.maximum(
        if_then_else(
            existing_pv_recycling_estimation_method() == 2,
            lambda: xr.DataArray(
                recycling_annual_expv() * weibull_pdf_early_loss_expv(),
                {"StudyPeriod": _subscript_dict["StudyPeriod"]},
                ["StudyPeriod"],
            ),
            lambda: if_then_else(
                ...
                lambda: xr.DataArray(
                    recycling_annual_expv() * weibull_pdf_regular_loss_expv(),
                    {"StudyPeriod": _subscript_dict["StudyPeriod"]},
                    ["StudyPeriod"],
                ),
                lambda: _delayfixed_dismantled_expv(),
            ),
        ),
        0,
    )
...
_delayfixed_dismantled_expv = DelayFixed(
    lambda: xr.DataArray(
        recycling_annual_expv(),
        {"StudyPeriod": _subscript_dict["StudyPeriod"]},
        ["StudyPeriod"],
    ),
    lambda: 25,
...
@component.add(
    ...
    comp_type="Stateful",
    comp_subtype="DelayFixed",
    depends_on={"_delayfixed_yield_avg_dummy_out": 1},
    other_deps={
        "_delayfixed_yield_avg_dummy_out": {
            "initial": {},
            "step": {"yield_avg_dummy_in": 1},
        }
    },
)
def yield_avg_dummy_out():
    return np.maximum(_delayfixed_yield_avg_dummy_out(), 0)


_delayfixed_yield_avg_dummy_out = DelayFixed(
    lambda: yield_avg_dummy_in(),
    lambda: 1,
    lambda: 1,
    time_step,
    "_delayfixed_yield_avg_dummy_out",
...
@component.add(
    ...
    other_deps={
        "_delayfixed_new_byproduction_yield_factor": {"initial": {}, "step": {}},
        "_integ_new_byproduction_yield_factor": {
            "initial": {"_delayfixed_new_byproduction_yield_factor": 1},
...
_delayfixed_new_byproduction_yield_factor = DelayFixed(
    lambda: 0,
    lambda: 0,
    lambda: 1,
    time_step,
    "_delayfixed_new_byproduction_yield_factor",
)

_integ_new_byproduction_yield_factor = NonNegativeInteg(
    lambda: yield_dummy_in() - yield_dummy_out(),
    lambda: _delayfixed_new_byproduction_yield_factor(),
    "_integ_new_byproduction_yield_factor",
)
...
@component.add(
    ...
    other_deps={
        "_delayfixed_new_dmgr_factor": {"initial": {}, "step": {}},
        "_integ_new_dmgr_factor": {
            "initial": {"_delayfixed_new_dmgr_factor": 1},
...
_delayfixed_new_dmgr_factor = DelayFixed(
    lambda: 0, lambda: 0, lambda: 1, time_step, "_delayfixed_new_dmgr_factor"
)

_integ_new_dmgr_factor = NonNegativeInteg(
    lambda: dmgr_dummy_in() - dmgr_dummy_out(),
    lambda: _delayfixed_new_dmgr_factor(),
    "_integ_new_dmgr_factor",
)
...
@component.add(
    ...
    other_deps={
        "_delayfixed_new_byproduction_yield_avg_factor": {"initial": {}, "step": {}},
        "_integ_new_byproduction_yield_avg_factor": {
            "initial": {"_delayfixed_new_byproduction_yield_avg_factor": 1},
...
_delayfixed_new_byproduction_yield_avg_factor = DelayFixed(
    lambda: 0,
    lambda: 0,
    lambda: 1,
    time_step,
    "_delayfixed_new_byproduction_yield_avg_factor",
)

_integ_new_byproduction_yield_avg_factor = NonNegativeInteg(
    lambda: yield_avg_dummy_in() - yield_avg_dummy_out(),
    lambda: _delayfixed_new_byproduction_yield_avg_factor(),
    "_integ_new_byproduction_yield_avg_factor",
)
