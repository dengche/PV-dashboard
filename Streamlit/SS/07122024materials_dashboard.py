...
if page == "Supply Gap and Price Effect":
    ...
    pv_price_threshhold = st.number_input("Please enter the price of the competitive technologies($/Wp)", min_value=0.00, step=0.01, value=0.00)
    ...
    if st.button("Save"):
        ...
        st.session_state.input["pv_price_threshhold"] = pv_price_threshhold
    ...
    if selected_inputs == "Supply Gap and Price Effect":
        if "save4" not in st.session_state:
            ...
            pv_price_df = pd.DataFrame({
                        ...
                        "Values": [inputs["pv_price_threshhold"],inputs["pv_tech_price"]],
                        })
