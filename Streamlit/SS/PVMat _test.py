...
from pysd.py_backend.functions import sum, if_then_else
from pysd.py_backend.statefuls import Integ, NonNegativeInteg, DelayFixed
...
def delayed_yield_effect():
    return DelayFixed(
        effect_on_material_byproduction_yield(), price_yield_delay(), 1, 1,"5",
    )
...
def recycling_annual_pv():
    value = xr.DataArray(np.nan, {"PVDev": _subscript_dict["PVDev"]}, ["PVDev"])
    value.loc[["Y2023"]] = DelayFixed(
        actual_annual_material_demand(), 0, 0, 1, "6",
    )
    value.loc[["Y2024"]] = DelayFixed(
        actual_annual_material_demand(), 1, 0, 1, "7",
    )
    value.loc[["Y2025"]] = DelayFixed(
        actual_annual_material_demand(), 2, 0, 1, "8",
    )
    value.loc[["Y2026"]] = DelayFixed(
        actual_annual_material_demand(), 3, 0, 1, "9",
    )
    value.loc[["Y2027"]] = DelayFixed(
        actual_annual_material_demand(), 4, 0, 1, "10",
    )
    value.loc[["Y2028"]] = DelayFixed(
        actual_annual_material_demand(), 5, 0, 1, "11",
    )
    value.loc[["Y2029"]] = DelayFixed(
        actual_annual_material_demand(), 6, 0, 1, "12",
    )
    value.loc[["Y2030"]] = DelayFixed(
        actual_annual_material_demand(), 7, 0, 1, "13",
    )
    value.loc[["Y2031"]] = DelayFixed(
        actual_annual_material_demand(), 8, 0, 1, "14",
    )
    value.loc[["Y2032"]] = DelayFixed(
        actual_annual_material_demand(), 9, 0, 1, "15",
    )
    value.loc[["Y2033"]] = DelayFixed(
        actual_annual_material_demand(), 10, 0, 1, "16",
    )
    value.loc[["Y2034"]] = DelayFixed(
        actual_annual_material_demand(), 11, 0, 1, "17",
    )
    value.loc[["Y2035"]] = DelayFixed(
        actual_annual_material_demand(), 12, 0, 1, "18",
    )
    value.loc[["Y2036"]] = DelayFixed(
        actual_annual_material_demand(), 13, 0, 1, "19",
    )
    value.loc[["Y2037"]] = DelayFixed(
        actual_annual_material_demand(), 14, 0, 1, "20",
    )
    value.loc[["Y2038"]] = DelayFixed(
        actual_annual_material_demand(), 15, 0, 1, "21",
    )
    value.loc[["Y2039"]] = DelayFixed(
        actual_annual_material_demand(), 16, 0, 1, "22",
    )
    value.loc[["Y2040"]] = DelayFixed(
        actual_annual_material_demand(), 17, 0, 1, "23",
    )
    value.loc[["Y2041"]] = DelayFixed(
        actual_annual_material_demand(), 18, 0, 1, "24",
    )
    value.loc[["Y2042"]] = DelayFixed(
        actual_annual_material_demand(), 19, 0, 1, "25",
    )
    value.loc[["Y2043"]] = DelayFixed(
        actual_annual_material_demand(), 20, 0, 1, "26",
    )
    value.loc[["Y2044"]] = DelayFixed(
        actual_annual_material_demand(), 21, 0, 1, "27",
    )
    value.loc[["Y2045"]] = DelayFixed(
        actual_annual_material_demand(), 22, 0, 1, "28",
    )
    value.loc[["Y2046"]] = DelayFixed(
        actual_annual_material_demand(), 23, 0, 1, "29",
    )
    value.loc[["Y2047"]] = DelayFixed(
        actual_annual_material_demand(), 24, 0, 1, "30",
    )
    value.loc[["Y2048"]] = DelayFixed(
        actual_annual_material_demand(), 25, 0, 1, "31",
    )
    value.loc[["Y2049"]] = DelayFixed(
        actual_annual_material_demand(), 26, 0, 1, "32",
    )
    value.loc[["Y2050"]] = DelayFixed(
        actual_annual_material_demand(), 27, 0, 1, "33",
    )
    return value
...
def direct_mining_supply_rough_estimate():
    ...
    """
    return DelayFixed(
        annual_production(), 0, direct_mining_current_production_user_input(), 1, "34",
    )
...
def delayed_dmgr_effect():
    return DelayFixed(
        effect_on_material_direct_mining_gr(), price_dmgr_delay(), 1, 1, "38"
    )
...
def delayed_yield_avg_effect():
    return DelayFixed(
        effect_on_material_byproduction_yield_avg(), price_yield_avg_delay(), 1, 1, "40",
    )
...
def yield_dummy_out():
    return DelayFixed(yield_dummy_in(), 1, 1, 1, "44",)
...
def dmgr_dummy_out():
    return DelayFixed(dmgr_dummy_in(), 1, 1, 1, "45",)
           ...
           if_then_else(
                ...
                lambda: if_then_else(
                   ...
                   lambda: recycling_annual_expv() * weibull_pdf_regular_loss_expv(),
                    lambda: DelayFixed(
                        recycling_annual_expv(), 25, 0, 1, "46",
                    ),
               ),
            ),
        {"StudyPeriod": _subscript_dict["StudyPeriod"]},
...
def total_annual_recycling_supply_from_existing_pv():
    return annual_dismantled_existing_pv()*collection_efficiency_expv()*percentage_panels_recycled_expv()*recycling_efficiency_expv()/10000,
...
def yield_avg_dummy_out():
    return DelayFixed(yield_avg_dummy_in(), 1, 1, 1, "47",)
